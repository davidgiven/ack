...
#define M_DB_SS                                                                                    \
	0200 /* debugger wants single stepping (to be orred                                            \
...
#define M_GETBYTES                                                                                 \
	5 /* get data; size in next LS bytes,                                                          \
 address in next PS bytes                                                                          \
*/
#define M_GETSTR                                                                                   \
	6 /* get string; max size in next LS bytes,                                                    \
 address in next PS bytes                                                                          \
*/
#define M_SETBYTES                                                                                 \
	7 /* get data; size in next LS bytes,                                                          \
 address in next PS bytes                                                                          \
*/
...
#define M_CONT (9 | M_DB_RUN)
	/* continue */
#define M_SETEMREGS                                                                                \
	10 /* set EM registers, level in next LS bytes;                                                \
