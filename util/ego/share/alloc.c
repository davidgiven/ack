...
int asizetab[] = { sizeof(arg_p) + sizeof(short) + sizeof(offset),
...
#else
int lsizetab[]
    = { sizeof(struct line), sizeof(struct line), sizeof(struct line), sizeof(struct line),
	    sizeof(struct line), sizeof(struct line), sizeof(struct line) };

int asizetab[] = { sizeof(struct arg), sizeof(struct arg), sizeof(struct arg), sizeof(struct arg),
	               sizeof(struct arg), sizeof(struct arg), sizeof(struct arg), sizeof(struct arg) };
#endif
