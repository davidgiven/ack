...
extern void StringAssign(int dstsiz, int srcsiz, char* dstaddr, char* srcaddr);
...
extern void load(size_t siz, char* addr, int p);
...
extern void store(size_t siz, char* addr, int p);
