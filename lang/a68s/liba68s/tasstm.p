...
52020 (**)
52030 (**)
52040 FUNCTION STRUCTSCOPE(STRUCTPTR: UNDRESSP; TEMPLATE: DPOINT):DEPTHRANGE; EXTERNAL;
52050 PROCEDURE GARBAGE(ANOBJECT:OBJECTP); EXTERNAL;
52060 FUNCTION NEXTEL(I: INTEGER; VAR PDESC1: PDESC): BOOLEAN; EXTERNAL;
52070 PROCEDURE PCINCR(STRUCTPTR: UNDRESSP; TEMPLATE: DPOINT; INCREMENT: INTEGER); EXTERNAL;
52080 PROCEDURE FORMPDESC(OLDESC: OBJECTP; VAR PDESC1: PDESC); EXTERNAL;
52090 PROCEDURE PCINCRMULT(ELSPTR: OBJECTP; INCREMENT: INTEGER); EXTERNAL;
52100 FUNCTION COPYDESC(ORIGINAL: OBJECTP; NEWSORT: STRUCTYPE): OBJECTP; EXTERNAL;
52110 PROCEDURE TESTCC (TARGET: OBJECTP); EXTERNAL;
52120 PROCEDURE ERRORR(N :INTEGER); EXTERNAL;
52130 FUNCTION CHKDESC(SOURCEMULT, CDESC: OBJECTP): OBJECTP; EXTERNAL;
52140 (**)
52150 (**)
