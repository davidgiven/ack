...
40020 (**)
40030 PROCEDURE GARBAGE (ANOBJECT: OBJECTP); EXTERNAL;
40040 PROCEDURE ERRORR(N :INTEGER); EXTERNAL;
40050 FUNCTION STRUCTSCOPE(STRUCTPTR: UNDRESSP; TEMPLATE: DPOINT):DEPTHRANGE; EXTERNAL;
40060 PROCEDURE UNDRESSN (COLLECTOR, STRUCTPTR: UNDRESSP; TEMPLATE: DPOINT; SOURCEP: OBJECTP); EXTERNAL ;
