...
88820  (**)
88830 PROCEDURE GARBAGE (ANOBJECT: OBJECTP); EXTERNAL ;
88840 PROCEDURE ERRORR(N :INTEGER); EXTERNAL ;
88850 PROCEDURE CLPASC5(P1,P2 :IPOINT; P3,P4 :INTEGER; P5 :IPOINT; PROC: ASPROC); EXTERNAL;
88860 PROCEDURE CLRDSTR(PCOV: OBJECTP; VAR CHARS: GETBUFTYPE; TERM (*+01() , TERM1 ()+01*) : TERMSET;
88870                   VAR I: INTEGER; BOOK: FETROOMP; PROC: ASPROC); EXTERNAL;
88880 PROCEDURE TESTF(RF:OBJECTP;VAR F:OBJECTP); EXTERNAL;
88890 FUNCTION ENSLINE(RF:OBJECTP;VAR F:OBJECTP):BOOLEAN; EXTERNAL;
88900 PROCEDURE ERRORSTATE(F:OBJECTP); EXTERNAL;
88910 (**)
88920 (**)
