...
08020 (**)
08030 (*+01() (*$X6*) ()+01*)
08040 PROCEDURE STANDINC(PCOV: OBJECTP; LFN: LFNTYPE); EXTERNAL;
08050 PROCEDURE STANDOUT(PCOV: OBJECTP; LFN: LFNTYPE); EXTERNAL;
08060 PROCEDURE STANDBAC(PCOV: OBJECTP; LFN: LFNTYPE); EXTERNAL;
08070 (*+01() (*$X4*) ()+01*)
08080 PROCEDURE CL68(PB: ASNAKED; RF: OBJECTP); EXTERNAL;
08090 PROCEDURE ERRORR(N: INTEGER); EXTERNAL;
08100 (*+05() FUNCTION TIME: REAL; EXTERNAL; ()+05*)
08110 PROCEDURE CALLPASC ; EXTERNAL;
08120 PROCEDURE ABORT; EXTERNAL;
08130 (*+02()
08140 PROCEDURE ACLS(FIL: FETROOMP); EXTERNAL;
08150 PROCEDURE STOPEN (VAR PF: FYL; VAR RF: OBJECTP; LFN: LFNTYPE; PROCEDURE CH(COV:OBJECTP;L:LFNTYPE) ); EXTERNAL;
08160 ()+02*)
08170 (*+01() (*$X6*) ()+01*)
08180 FUNCTION PROC(PROCEDURE P):ASPROC;EXTERNAL;
08190 (*-01()
08200 FUNCTION PROCH( PROCEDURE P( COV: OBJECTP ; L: LFNTYPE ) ): ASPROC ; EXTERNAL ;
08210 ()-01*)
08220 (*+01() (*$X4*) ()+01*)
08230 (**)
08240 (*+24()
...
11940       I: INTEGER;
11950       EFET: INTEGER;
11960 (*+01() PROCEDURE ESTART(CURR: IPOINT); EXTERNAL; ()+01*)
11970 (*+02() PROCEDURE ESTART_(VAR INF,OUTF : TEXT); EXTERNAL;
11980         FUNCTION MAXR REAL; EXTERNAL; ()+02*)
...
13360 (*+01() PROCEDURE PEND(EFET: INTEGER); EXTERNAL; ()+01*)
13370 (*+02() PROCEDURE ESTOP_; EXTERNAL; ()+02*)
13380     BEGIN
