...
88520  (**)
88530 PROCEDURE GARBAGE (ANOBJECT: OBJECTP); EXTERNAL ;
88540 PROCEDURE ERRORR(N :INTEGER); EXTERNAL ;
88550 PROCEDURE CLPASC5(P1,P2 :IPOINT; P3,P4 :INTEGER; P5 :IPOINT; PROC: ASPROC); EXTERNAL;
88560 PROCEDURE TESTF(RF:OBJECTP;VAR F:OBJECTP); EXTERNAL;
88570 (**)
88580 (**)
88590 (*+01() (*$X6*) ()+01*)
