...
50320 (**)
50330 PROCEDURE PCINCR (STRUCTPTR: UNDRESSP; TEMPLATE: DPOINT; INCREMENT: INTEGER); EXTERNAL;
50340 PROCEDURE GARBAGE(ANOBJECT:OBJECTP); EXTERNAL;
50350 PROCEDURE ERRORR(N :INTEGER); EXTERNAL;
50360 FUNCTION STRUCTSCOPE(STRUCTPTR: UNDRESSP; TEMPLATE: DPOINT):DEPTHRANGE; EXTERNAL;
50370 FUNCTION SAFEACCESS(LOCATION: OBJECTP): UNDRESSP; EXTERNAL;
50380 (**)
50390 (**)
