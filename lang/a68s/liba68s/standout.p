...
91320 (**)
91330 (*+05() PROCEDURE FLSBUF(P: PCFILE; CH: CHAR); EXTERNAL; ()+05*)
91340 (*+02()
91350 PROCEDURE STOPEN (VAR PF: FYL; VAR RF: OBJECTP; LFN: LFNTYPE; PROCEDURE CH(COV:OBJECTP;L:LFNTYPE) ); EXTERNAL;
91360 ()+02*)
91370 (**)
91380 (**)
91390 (**)
...
91420 (*+05()
91430   PROCEDURE WRC(P: PCFILE; CH: CHAR); EXTERNAL;
91440 ()+05*)
...
92050 (*+01()
92060   (*$X0*)
92070   PROCEDURE WRS(VAR FYLE: FYL; ADDR: UNDRESSP; FLDLGTH, STRLGTH: INTEGER); EXTERNAL;
92080   PROCEDURE WRSN(VAR FYLE: FYL; SHORTSTR: INTEGER; FLDLGTH, STRLGTH: INTEGER); EXTERNAL;
92090   (*$X4*)
92100 ()+01*)
92110 (*+02()
92120       CPTR: IPOINT;
92130   PROCEDURE WRC(CH :CHAR; FIL :FETROOMP); EXTERNAL;
92140   PROCEDURE WRS(LEN :INTEGER; CP :IPOINT; FIL :FETROOMP); EXTERNAL;
92150 ()+02*)
92160 (*+05()
92170       CPTR: CHARPOINT ;
92180   PROCEDURE WRS(P: PCFILE; CP: CHARPOINT; LEN: INTEGER ); EXTERNAL;
92190   PROCEDURE WRC(P: PCFILE; CH: CHAR); EXTERNAL;
92200 ()+05*)
92210     BEGIN
92220 (*+01()
92230     WIDTH := 1;
