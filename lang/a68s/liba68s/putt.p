...
83320  (**)
83330 PROCEDURE CL68(PB: ASNAKED; RF: OBJECTP); EXTERNAL ;
83340 PROCEDURE GARBAGE (ANOBJECT: OBJECTP); EXTERNAL ;
83350 PROCEDURE FORMPDESC(OLDESC: OBJECTP; VAR PDESC1: PDESC); EXTERNAL ;
83360 FUNCTION NEXTEL(I: INTEGER; VAR PDESC1: PDESC): BOOLEAN; EXTERNAL ;
83370 PROCEDURE ERRORR(N :INTEGER); EXTERNAL ;
83380 FUNCTION CRSTRING(LENGTH: OFFSETRANGE): OBJECTP; EXTERNAL ;
83390 FUNCTION GETPROC(RN: OBJECTP): ASNAKED; EXTERNAL ;
83400 PROCEDURE TESTF(RF:OBJECTP;VAR F:OBJECTP); EXTERNAL;
83410 FUNCTION ENSLINE(RF:OBJECTP;VAR F:OBJECTP):BOOLEAN; EXTERNAL;
83420 PROCEDURE ENSSTATE(RF:OBJECTP;VAR F:OBJECTP;READING:STATUSSET); EXTERNAL;
83430 FUNCTION ENSPAGE(RF:OBJECTP;VAR F:OBJECTP):BOOLEAN; EXTERNAL;
83440 (**)
83450 PROCEDURE CLPASC1(P1: IPOINT; PROC: ASPROC); EXTERNAL;
83460 PROCEDURE CLPASC5(P1,P2 :IPOINT; P3,P4 :INTEGER; P5 :IPOINT; PROC: ASPROC); EXTERNAL;
83470 FUNCTION NXTBIT(VAR N: INTEGER): INTEGER; EXTERNAL;
83480 (**)
83490 (**)
83500 (*+01() (*$X6*) ()+01*) (*ONLY USED WITH PROC*)
83510 (*+01() FUNCTION TIMESTEN(T, E: INTEGER): REAL ; EXTERNAL ; ()+01*)
83520 (*+05() FUNCTION TIMESTEN( T: REAL; E: INTEGER ): REAL ; EXTERNAL ; ()+05*)
83530 (*+01() (*$X4*) ()+01*)
83540 (**)
83550 (**)
