...
88120  (**)
88130 PROCEDURE GARBAGE (ANOBJECT: OBJECTP); EXTERNAL ;
88140 PROCEDURE ERRORR(N :INTEGER); EXTERNAL ;
88150 PROCEDURE TESTF(RF:OBJECTP;VAR F:OBJECTP); EXTERNAL;
88160 PROCEDURE SETREADMOOD(PCOV:OBJECTP); EXTERNAL;
88170 PROCEDURE SETWRITEMOOD(PCOV:OBJECTP); EXTERNAL;
88180 PROCEDURE SETCHARMOOD(PCOV:OBJECTP); EXTERNAL;
88190 (**)
88200 (**)
