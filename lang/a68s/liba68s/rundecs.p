...
61900 (**)
61905 (*+02()
61910  FUNCTION TIMESTE (T:REAL; E:INTEGER) :REAL; EXTERNAL;
61945 ()+02*)
61950 (**)
62000 (*+01() (*$E+*) ()+01*)
62050 (**)
...
64150 (**)
64200 (**)
64300 FUNCTION ME: IPOINT; EXTERNAL; (*STACK FRAME POINTER OF CALLER*)
64350 FUNCTION STATIC(IB: IPOINT): IPOINT; EXTERNAL; (*FOLLOW STATIC CHAIN*)
64400  (*+05() FUNCTION A68STATIC(IB: IPOINT): IPOINT; EXTERNAL; (*FOLLOW ALGOL 68S STATIC CHAIN*) ()+05*)
64450 FUNCTION DYNAMIC(IB: IPOINT): IPOINT; EXTERNAL; (*FOLLOW DYNAMIC CHAIN*)
64452 (*+02() FUNCTION ARGBASE(IB: IPOINT): IPOINT; EXTERNAL; ()+02*)
64500 FUNCTION ISA68(IB: IPOINT): BOOLEAN; EXTERNAL; (*IB IS FRAME FOR A68 PROC*)
64550 FUNCTION ISPUT(IB: IPOINT): BOOLEAN; EXTERNAL; (*IB IS FRAME FOR CALL OF PUTT*)
64600 FUNCTION ISGET(IB: IPOINT): BOOLEAN; EXTERNAL; (*IB IS FRAME FOR CALL OF GETT*)
64650 PROCEDURE SETMYSTATIC(IB: IPOINT); EXTERNAL; (*SETS STATIC CHAIN OF CALLER*)
