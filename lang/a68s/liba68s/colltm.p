...
20620 (**)
20630 (**)
20640 PROCEDURE ERRORR(N :INTEGER); EXTERNAL;
20650 PROCEDURE GARBAGE(ANOBJECT:OBJECTP); EXTERNAL;
20660 FUNCTION NEXTEL(I: INTEGER; VAR PDESC1: PDESC): BOOLEAN; EXTERNAL;
20670 PROCEDURE PCINCRSLICE(MULT: OBJECTP; VAR APDESC: PDESC; INCREMENT: INTEGER); EXTERNAL;
20680 PROCEDURE PCINCRMULT(ELSPTR: OBJECTP; INCREMENT: INTEGER); EXTERNAL;
20690 PROCEDURE FORMPDESC(OLDESC: OBJECTP; VAR PDESC1: PDESC); EXTERNAL;
20700 (**)
20710 (**)
