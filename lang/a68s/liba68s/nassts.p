...
38920 (**)
38930 PROCEDURE GARBAGE (ANOBJECT: OBJECTP); EXTERNAL;
38940 PROCEDURE ERRORR(N :INTEGER); EXTERNAL;
38950 PROCEDURE TESTCC(TARGET: OBJECTP); EXTERNAL ;
