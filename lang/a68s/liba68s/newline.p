...
79220  (**)
79230 PROCEDURE GARBAGE (ANOBJECT: OBJECTP); EXTERNAL ;
79240 PROCEDURE ERRORR(N :INTEGER); EXTERNAL ;
79250 PROCEDURE TESTF(RF:OBJECTP;VAR F:OBJECTP); EXTERNAL;
79260 FUNCTION ENSPAGE(RF:OBJECTP;VAR F:OBJECTP):BOOLEAN; EXTERNAL;
79270 FUNCTION ENSPHYSICALFILE(RF:OBJECTP;VAR F:OBJECTP):BOOLEAN; EXTERNAL;
79280 (**)
79290 PROCEDURE CLPASC2(P1,P2: IPOINT; PROC: ASPROC); EXTERNAL;
79300 (**)
79310 (**)
