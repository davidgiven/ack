...
98420  (**)
98430 PROCEDURE SETWRITEMOOD(PCOV:OBJECTP); EXTERNAL;
98440 (*+01() (*$X6*) ()+01*)
98450 PROCEDURE AOPEN( EFET:FETROOMP; DISP:INTEGER; LFN:LFNTYPE; BUF:IPOINT ); EXTERNAL;
98460 FUNCTION PROC( PROCEDURE P (*-01() ( COV: OBJECTP ; EFET: FETROOMP ) ()-01*) ): ASPROC ; EXTERNAL ;
98470 (*-01()
98480 FUNCTION PROC2( PROCEDURE P( COV, STRNG: OBJECTP ; LB, UB: INTEGER ; EFET: FETROOMP ) ): ASPROC ; EXTERNAL ;
98490 ()-01*)
98500 PROCEDURE SONEWLINE(COV: OBJECTP; EFET: FETROOMP); EXTERNAL;
98510 PROCEDURE SONEWPAGE(COV: OBJECTP; EFET: FETROOMP); EXTERNAL;
98520 PROCEDURE SORESET(COV: OBJECTP; EFET: FETROOMP); EXTERNAL;
98530 PROCEDURE SOWRSTR(COV, STRNG: OBJECTP; LB, UB: INTEGER; EFET: FETROOMP); EXTERNAL;
98540 (**)
98550 (**)
