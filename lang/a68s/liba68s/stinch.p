...
93220 (**)
93230 PROCEDURE SETREADMOOD(PCOV:OBJECTP); EXTERNAL;
93240 (**)
93250 (*+01() (*$X6*) ()+01*)
93260 FUNCTION PROC( PROCEDURE P (*-01() ( COV: OBJECTP ; EFET: FETROOMP ) ()-01*) ): ASPROC ; EXTERNAL ;
93270 (*-01()
93280 FUNCTION PROC1(
93290   PROCEDURE P( COV: OBJECTP ; CHARS: GETBUFTYPE ; TERM: TERMSET ; I: INTEGER ; EFET: FETROOMP )
93300               ): ASPROC ; EXTERNAL ;
93310 ()-01*)
93320 PROCEDURE AOPEN( EFET:FETROOMP; DISP:INTEGER; LFN:LFNTYPE; BUF:IPOINT ); EXTERNAL;
93330 PROCEDURE SIRDSTR(COV: OBJECTP; CHARS: GETBUFTYPE; TERM (*+01(),TERM1()+01*): TERMSET; I: INTEGER; EFET: FETROOMP);
93340     EXTERNAL;
93350 PROCEDURE SINEWLINE(COV: OBJECTP; EFET: FETROOMP); EXTERNAL;
93360 PROCEDURE SINEWPAGE(COV: OBJECTP; EFET: FETROOMP); EXTERNAL;
93370 PROCEDURE SIRESET(COV: OBJECTP; EFET: FETROOMP); EXTERNAL;
93380 (**)
93390 (**)
