...
81020  (**)
81030 PROCEDURE ACLOSE(EFET: FETROOMP); EXTERNAL;
81040 PROCEDURE GARBAGE (ANOBJECT: OBJECTP); EXTERNAL ;
81050 PROCEDURE ERRORR(N :INTEGER); EXTERNAL ;
81060 FUNCTION SAFEACCESS(LOCATION: OBJECTP): UNDRESSP; EXTERNAL;
81070 PROCEDURE PCINCR (STRUCTPTR: UNDRESSP; TEMPLATE: DPOINT; INCREMENT: INTEGER); EXTERNAL ;
81080 FUNCTION CRSTRING(LENGTH: OFFSETRANGE): OBJECTP; EXTERNAL ;
81090 PROCEDURE SETWRITEMOOD(PCOV: OBJECTP); EXTERNAL;
81100 PROCEDURE TESTF(RF:OBJECTP;VAR F:OBJECTP); EXTERNAL;
81110 (*+02()
81120 PROCEDURE AOPN(FIL: FETROOMP); EXTERNAL;
81130 PROCEDURE ACRE(FIL: FETROOMP); EXTERNAL;
81140 ()+02*)
81150 (**)
81160 (*+01() (*$X6*) ()+01*)
...
81210 (**)
81220 (**)
81230 FUNCTION FUNC68(PB: ASNAKED; RF: OBJECTP): BOOLEAN; EXTERNAL;
81240 (**)
81250 (**)
81260 (*+02()
...
81440   PROCEDURE NAMEFILE(CHARVEC: VECCHARS; SU, SL: INTEGER; VAR FIL: ANYFILE); EXTERNAL;
81450   BEGIN
