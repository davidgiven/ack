...
70020  (**)
70030 PROCEDURE GARBAGE (ANOBJECT: OBJECTP); EXTERNAL ;
70040 PROCEDURE ERRORR(N :INTEGER); EXTERNAL ;
70050 FUNCTION SAFEACCESS(LOCATION: OBJECTP): UNDRESSP; EXTERNAL;
70060 PROCEDURE PCINCR (STRUCTPTR: UNDRESSP; TEMPLATE: DPOINT; INCREMENT: INTEGER); EXTERNAL ;
70070 (**)
70080 (**)
70090 (*+01() (*$X6*) ()+01*)
70100 FUNCTION PROC( PROCEDURE P (*-01() ( COV: OBJECTP ; EFET: FETROOMP ) ()-01*) ): ASPROC ; EXTERNAL ;
70110 (*-01()
70120 FUNCTION PROC1(
70130   PROCEDURE P( COV: OBJECTP ; CHARS: GETBUFTYPE ; TERM: TERMSET ; I: INTEGER ; EFET: FETROOMP )
70140               ): ASPROC ; EXTERNAL ;
70150 FUNCTION PROC2( PROCEDURE P( COV, STRNG: OBJECTP ; LB, UB: INTEGER ; EFET: FETROOMP ) ): ASPROC ; EXTERNAL ;
70160 FUNCTION PROC3( PROCEDURE P( COV: OBJECTP ; P, L, C: INTEGER ; EFET: FETROOMP ) ): ASPROC ; EXTERNAL ;
70170 FUNCTION PROCH( PROCEDURE P( COV: OBJECTP ; L: LFNTYPE ) ): ASPROC ; EXTERNAL ;
70180 ()-01*)
70190 PROCEDURE ASSWRSTR(COV, PUTSTRING: OBJECTP; LB, UB: INTEGER; EFET: FETROOMP); EXTERNAL;
70200 PROCEDURE ASSRDSTR(COV:OBJECTP; CHARS:GETBUFTYPE; TERM(*+01(),TERM1()+01*): TERMSET; I: INTEGER; EFET: FETROOMP);
70210     EXTERNAL;
70220 PROCEDURE ASSNEWLINE(COV: OBJECTP; EFET: FETROOMP); EXTERNAL;
70230 PROCEDURE ASSNEWPAGE(COV: OBJECTP; EFET: FETROOMP); EXTERNAL;
70240 PROCEDURE ASSRESET(COV: OBJECTP; EFET: FETROOMP); EXTERNAL;
70250 PROCEDURE ASSSET(COV: OBJECTP; P, L, C: INTEGER; EFET: FETROOMP); EXTERNAL;
70260 (**)
70270 (**)
