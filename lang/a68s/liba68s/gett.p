...
75220  (**)
75230 PROCEDURE CL68(PB: ASNAKED; RF: OBJECTP); EXTERNAL ;
75240 PROCEDURE GARBAGE (ANOBJECT: OBJECTP); EXTERNAL ;
75250 PROCEDURE FORMPDESC(OLDESC: OBJECTP; VAR PDESC1: PDESC); EXTERNAL ;
75260 FUNCTION NEXTEL(I: INTEGER; VAR PDESC1: PDESC): BOOLEAN; EXTERNAL ;
75270 PROCEDURE ERRORR(N :INTEGER); EXTERNAL ;
75280 FUNCTION SAFEACCESS(LOCATION: OBJECTP): UNDRESSP; EXTERNAL;
75290 PROCEDURE TESTCC (TARGET: OBJECTP); EXTERNAL ;
75300 PROCEDURE TESTSS (REFSTRUCT: OBJECTP); EXTERNAL ;
75310 FUNCTION CRSTRING(LENGTH: OFFSETRANGE): OBJECTP; EXTERNAL ;
75320 FUNCTION GETPROC(RN: OBJECTP): ASNAKED; EXTERNAL ;
75330 PROCEDURE CLPASC1(P1: IPOINT; PROC: ASPROC); EXTERNAL;
75340 PROCEDURE CLRDSTR(PCOV: OBJECTP; VAR CHARS: GETBUFTYPE; TERM (*+01() , TERM1 ()+01*) : TERMSET;
75350                   VAR I: INTEGER; BOOK: FETROOMP; PROC: ASPROC); EXTERNAL;
75360 FUNCTION FUNC68(PB: ASNAKED; RF: OBJECTP): BOOLEAN; EXTERNAL;
75370 PROCEDURE TESTF(RF:OBJECTP;VAR F:OBJECTP); EXTERNAL;
75380 PROCEDURE ENSSTATE(RF:OBJECTP;VAR F:OBJECTP;READING:STATUSSET); EXTERNAL;
75390 FUNCTION ENSPAGE(RF:OBJECTP;VAR F:OBJECTP):BOOLEAN; EXTERNAL;
75400 FUNCTION ENSLINE(RF:OBJECTP;VAR F:OBJECTP):BOOLEAN; EXTERNAL;
75410 (**)
75420 (**)
