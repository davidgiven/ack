...
71820  (**)
71830 PROCEDURE GARBAGE(ANOBJECT: OBJECTP); EXTERNAL;
71840 PROCEDURE ERRORR(N :INTEGER); EXTERNAL ;
71850 PROCEDURE CLPASC2(P1,P2: IPOINT; PROC: ASPROC); EXTERNAL;
71860 (**)
71870 (**)
71880 (*+01() (*$X4*) ()+01*)
71890 FUNCTION FUNC68(PB: ASNAKED; RF: OBJECTP): BOOLEAN; EXTERNAL;
71900 (**)
71910 (**)
71920 PROCEDURE NEWLINE(RF:OBJECTP); EXTERNAL;
