...
31330  (**)
31340  (*-01() (*-03() (*-04()
31350  FUNCTION GETADDRESS(VAR VARIABLE:INTEGER): ADDRINT; EXTERNAL;
31360  (**)
...
31510        GETMEM(FRIG.PLEXP, ( HEAPLENGTH)*SZWORD);
...
31871 ()+05*)
31880      IF EOF(LGO) THEN GETMEM(FRIG.PLEXP, (SZREAL)*SZWORD)
31890      ELSE GETMEM(FRIG.PLEXP, (2*SZREAL)*SZWORD);
...
31941 ()-02*)
31943 (*+02()
31945      GETMEM(FRIG.POINT, (100)*SZWORD); (* TO MAKE SURE IT GOES AT THE END *)
31947 ()+02*)
