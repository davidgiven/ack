...
12480   PROCEDURE NAMEFILE(S: ARGSTRING; SU, SL: INTEGER; VAR F: ANYFILE); EXTERNAL;
12490   FUNCTION GETARG(VAR S: ARGSTRING; SU, SL: INTEGER; I: INTEGER): BOOLEAN; EXTERNAL;
12500     BEGIN
...
12570   PROCEDURE NAMEFILE(S: ARGSTRING; SU, SL: INTEGER; VAR F: ANYFILE); EXTERNAL;
12580   FUNCTION GETARG(VAR S: ARGSTRING; SU, SL: INTEGER; I: INTEGER): BOOLEAN; EXTERNAL;
12590     BEGIN
12600     IF GETARG(S, 50, 1, PARAM) THEN
12610       NAMEFILE(S, 50, 1, F);
12620     IF WRITING THEN REWRITE(F) ELSE RESET(F);
12630     END;
12632 FUNCTION TIME: INTEGER; EXTERNAL;
12634 PROCEDURE CTIME(VAR RESULT: TIMSTRING; SU, SL: INTEGER; CLOCK: INTEGER); EXTERNAL;
12640 ()+05*)
12650 (**)
12660 (**)
...
18780         GETMEM(THIS, ( LXCOUNT*SZWORD+LEX1SIZE)*SZWORD);
...
24920     BEGIN
24930     GETMEM(CURRENTMD, ( MODE1SIZE)*SZWORD);
...
25090     ELSE BEGIN
25100       GETMEM(CURRENTMD, ( MODE1SIZE)*SZWORD);
...
25320     GETMEM(CURRENTMD, ( LENGTH+MODE1SIZE)*SZWORD);
...
25890     GETMEM(CURRENTMD, ( LENGTH+MODE1SIZE)*SZWORD);
