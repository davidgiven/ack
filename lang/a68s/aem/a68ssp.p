...
42801 (*+05()      BEGIN
42802              GETMEM(LEX, ( LEX1SIZE + LX^.LXCOUNT*SZWORD)*SZWORD);
...
42920            BEGIN
42930            STMODE := MD;
42940            GETMEM(LX, ( SZADDR+SZINT+LEX1SIZE)*SZWORD); WITH LX^ DO
...
43060          BEGIN
43070          STMODE:=MD;
43080          GETMEM(LX, (SZADDR+SZREAL+LEX1SIZE)*SZWORD);
43090          WITH LX^ DO
43100            BEGIN
