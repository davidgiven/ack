...
95580 (**)
95590 (**)
95592 PROCEDURE ABORT; EXTERNAL;
95600 (**)
95610 (*+80()
95620 (**)
95630 (*+01()
...
96160 (**)
96170 (**)
96190 PROCEDURE ACLOSE(VAR F: FYL); EXTERNAL;
96200 (**)
96210 (**)
...
96900 (**)
96910 (**)
96920 PROCEDURE LOADGO(VAR LGO: LOADFILE); EXTERNAL;
96930 (**)
96940 (**)
96950 (*$E++)
...
97140 (**)
97150 (*-01() (*-03() (*-04()
97160 FUNCTION GETADDRESS(VAR VARIABLE:INTEGER): ADDRINT; EXTERNAL;
97170 (**)
...
97330       GETMEM(FRIG.PLEXP, ( HEAPLENGTH)*SZWORD);
