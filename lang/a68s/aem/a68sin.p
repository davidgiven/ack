...
34130        BEGIN
34140        GETMEM(LEX, ( LEX1SIZE)*SZWORD);
34150        LEX^.LXV := LXV;
34160        LEX^.LXCOUNT := 0;
34170        END;
34180  ()+81*)
...
34440          GETMEM(LEX, ( LEX1SIZE+LXCOUNT*SZWORD)*SZWORD);
...
39070          BEGIN GETMEM(V, ( MODE1SIZE)*SZWORD); V^.MDV := MDV END;
...
40880      GETMEM(LEXALEPH, ( LEX1SIZE)*SZWORD); WITH LEXALEPH^ DO
40890        BEGIN LXV:=LXVTAG; LXCOUNT:=0; LXTOKEN:=TKTAG END;
40900        BOLDWORDS;
40910  ()+81*)
40920  (*+84() INITMODES; ()+84*)
40930  (*+84()
40940      GETMEM(LEXONE, ( SZADDR+SZINT+LEX1SIZE)*SZWORD); WITH LEXONE^ DO
